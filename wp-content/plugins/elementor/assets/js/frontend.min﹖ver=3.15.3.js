    ...
    [819], {
        ...
        9804: (e, t, n) => {
            ...
            e.exports = function(e) {
                ...
                }, elementorFrontendConfig.experimentalFeatures["nested-elements"] && (this.elementsHandlers["nested-tabs.default"] = () => Promise.resolve().then(n.bind(n, 7323)), this.elementsHandlers["nested-accordion.default"] = () => Promise.resolve().then(n.bind(n, 32)));
        ...
        3308: (e, t) => {
            ...
            const matchUserAgent = e => n.indexOf(e) >= 0,
                ...
                s = !!window.opr && !!opr.addons || !!window.opera || matchUserAgent("OPR/index.html"),
